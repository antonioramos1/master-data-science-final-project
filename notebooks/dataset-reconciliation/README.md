...
The main challenge we are facing is due to some websites having antiscraping and antiscripting protections.
...
Other challenges faced here include broken URLs, rectricted access to certain websites for EU individuals, placeholder images for expired items and corrupted images.
